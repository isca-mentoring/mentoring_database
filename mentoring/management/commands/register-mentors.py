...
from mentoring.scripts.modify_mentor_registration_data import main
from os.path import exists, join


class Command(BaseCommand):
    help = 'Register mentor form data into DB'
    ...
    def handle(self, *args, **options):
        try:
            ...
            expected_file = join(mentor_form_import_dir, f"{form_name}.csv")
